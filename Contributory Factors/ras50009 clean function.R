library(readODS)
ras50009_clean = function(address,year,n_or_p){
  col_name = c('Speed Factor','Motorcycles','Cars','Light goods vehicles','Heavy goods vehicles','All vehicles')
...
address = c('C:/Users/zeradias/Desktop/Dissertation/ODS/ras50009.ods')
test = ras50009_clean(address,2,'percent')
nrow(test)
